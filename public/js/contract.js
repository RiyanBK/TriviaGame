...
const CONTRACT_ADDRESS = "0xc02022e84878A0E7c0Bdd74A88e9C0AAB67D4cE9";
...
const CONTRACT_ABI = [
  [
    ...
    },
    {
      ...
      outputs: [
        { name: "", type: "uint8", components: null, internalType: null },
        { name: "", type: "bytes32", components: null, internalType: null },
      ],
    },
    {
      type: "function",
      name: "getCurrentQuestionCategory",
      stateMutability: "view",
      inputs: [
        {
          name: "gameId",
    ...
    },
    {
      ...
      inputs: [
        { name: "arg0", type: "uint256", components: null, internalType: null },
        { name: "arg1", type: "uint256", components: null, internalType: null },
      ],
      outputs: [
        {
          name: "",
    ...
    try {
      ...
      if (network.chainId !== 11155111) {
        ...
        document.getElementById("network-info").innerHTML +=
          "<br>Please switch to Sepolia testnet in MetaMask.";
        return false;
      }
